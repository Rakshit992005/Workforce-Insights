...
const ListItems = (props) => {
  ...
  return (
    <div
      onClick={(e) => detailsHandler(e)}
      className="group grid grid-cols-6 gap-4 px-6 py-4 items-center cursor-pointer bg-white border-b border-slate-100 hover:bg-slate-50 transition-all duration-200 animate-fade-in"
    >
      ...
      <div>
        <span className="text-xs text-text-muted">{item[4]}</span>
      </div>
